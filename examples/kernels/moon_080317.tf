...
KPL/FK
   ...
   lunar reference systems:
      ...
      Lunar principal axis frames realizing the lunar PA system and
      specified by this kernel are associated with JPL planetary
      ephemerides. Each new JPL planetary ephemeris can (but does not
      necessarily) define a new realization of the lunar principal axis
      ...
      a given ephemeris version and the associated principal axis frame
   ...
   associated principal axis frame for the same DE is given by a
   ...
   *not* by absolute value.
   ...
   MOON_PA is the name of the generic lunar principal axis (PA) reference
   frame. This frame is an alias for the principal axis frame defined
   ...
   alias for the lunar principal axis frame associated with the
   ...
   MOON_PA_DE421 is the name of the lunar principal axis
