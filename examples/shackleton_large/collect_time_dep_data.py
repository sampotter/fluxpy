...
if compression_type == 'true_model' or compression_type == 'stoch_radiosity':
    ...
    V = np.load(f'shackleton_verts_{max_inner_area_str}_{max_outer_area_str}.npy')
    F = np.load(f'shackleton_faces_{max_inner_area_str}_{max_outer_area_str}.npy')
...
fout = f'shackleton_{max_inner_area_str}_{max_outer_area_str}_st.ply'
mesh.write(fout)
