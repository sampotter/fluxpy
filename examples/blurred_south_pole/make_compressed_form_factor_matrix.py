...
if compression_type == "true_model":
    ...
    savedir = "stoch_rad_{}_{}_{}_{}k0".format(max_area_str, outer_radius_str, sigma_str, args.k0)
    ...
    savedir = "sparse_hier_{}_{}_{}_{:.0e}".format(max_area_str, outer_radius_str, sigma_str, args.tol)
